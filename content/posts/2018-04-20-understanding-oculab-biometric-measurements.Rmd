...
Note: I cannot determine the unit of measurement for the keratometry values with certainty through research but I suspect that the K-values are given as dioptric power (or refractive power) which would be dependent on the curvature of the cornea, and the axes measurements are in degrees.
